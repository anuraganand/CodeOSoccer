...
namespace Strategy
{
  template <class T> class KDTree; ///<Template
}
...
namespace Strategy
{
  typedef struct
  {
    float x, y; ///<float type variables , x and y hold coodinates of the obstacle 
    float radius; ///<Float type to hold obstacle radius
  } obstacle;
