...
void GraphicalDebugger::addCircle(int x, int y, int radius) {
    DebugCircle d(x,y,radius);
    circleList[frameNo].push_back(d);
}
void GraphicalDebugger::addLine(int x1, int y1, int x2, int y2) {
    DebugLine d(x1, y1, x2, y2);
