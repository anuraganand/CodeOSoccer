...
namespace HAL
{
   ...
   */
  const int BlueMarkerMap[]   = {0, 1, 2, 3, 4, -1, -1, -1, -1, -1, -1, -1};
  const int YellowMarkerMap[] = {0, 1, 2, 3, 4, -1, -1, -1, -1, -1, -1, -1};
   ...
   */
  const int BlueMarkerMap[]   = {0, 1, 2, 3, 4};
  const int YellowMarkerMap[] = {0, 1, 2, 3, 4};
  ...
  //------ Protocols for receiving Referee Box commands ------//

  const char    REF_BOX_MULTICAST_ADDR[] = "224.5.23.1";
  const unsigned short REF_BOX_MULTICAST_PORT = 10001;
